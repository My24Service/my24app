...
void main() async {
  ...
  testWidgets('loads main list', (tester) async {
    ...
    when(
        client.get(Uri.parse('https://demo.my24service-dev.com/api/order/order/dispatch_list_unassigned/'),
            headers: anyNamed('headers')
        )
    ...
    OrdersUnAssignedPage widget = OrdersUnAssignedPage(bloc: orderBloc);
    ...
    expect(find.byType(OrdersUnAssignedWidget), findsOneWidget);
    expect(find.byType(OrdersUnAssignedErrorWidget), findsNothing);
    expect(find.byType(OrdersUnAssignedEmptyWidget), findsNothing);
  });
  ...
  testWidgets('loads main list empty', (tester) async {
    ...
    expect(find.byType(OrdersUnAssignedWidget), findsNothing);
    expect(find.byType(OrdersUnAssignedErrorWidget), findsNothing);
    expect(find.byType(OrdersUnAssignedEmptyWidget), findsOneWidget);
  });
  ...
  testWidgets('loads main list error', (tester) async {
    ...
    expect(find.byType(OrdersUnAssignedWidget), findsNothing);
    expect(find.byType(OrdersUnAssignedErrorWidget), findsOneWidget);
    expect(find.byType(OrdersUnAssignedEmptyWidget), findsNothing);
  });
}
